...
Same mock names and `10.20.x` space as `aws_network_diagram1.md` / `describe_json1`.

```mermaid
flowchart LR
  subgraph vm["vm-XXXX-job-01"]
    job[batch job]
  ...
  subgraph proxy["HTTP proxy"]
    px["px-uat.xxxx.example.com:12221"]
  end

  subgraph dest["SFTP server"]
    gccp["sftp-uat.xxxx.example.com\n10.20.128.4 (cloud)"]
    ip209["10.20.128.8 (cloud Azure)"]
...
flowchart LR
  ...
  subgraph dest["SFTP server"]
    agency1["10.20.128.8 (cloud Azure)\n \nGET /agency1/OUT/Process\nPUT /agency1/OUT/Archive\nPUT /agency1/IN\n \nuser  asaxxxxcisuiagutsftp01.agency1sftp"]
  end
  py --> px
...
flowchart LR
  ...
  subgraph dest["SFTP server"]
    agency6["10.20.128.8 (cloud Azure)\n \nGET /agency6/\n \nuser  asaxxxxcisuiagutsftp01.agency6sftp"]
  end
  api --> px
...
flowchart LR
  ...
  subgraph dest["SFTP server"]
    agency7["10.20.128.8 (cloud Azure)\n \nPUT /agency7/\n \nuser  asaxxxxcisuiagutsftp01.agency7sftp"]
  end
  api --> px
...
flowchart LR
  ...
  subgraph dest["SFTP server"]
    agency8["10.20.128.8 (cloud Azure)\n \nGET /agency8/\n \nuser  asaxxxxcisuiagutsftp01.agency8sftp"]
  end
  py --> px
